...
BounceEni::BounceEni(int x,int y):Eni(x,y)
{
    //ctor
    falling = true;
    m_velX=-2;
...
void BounceEni::moov(int vx,int vy)
{
    m_posX+=vx;
    m_posY+=vy;
}
...
void BounceEni::recursiveMoov(int velX,int velY,SDL_Rect hitBox,MapProto* mapProto)
{
...
void BounceEni::fallControle(MapProto* mapProto)
{
    SDL_Rect hitBoxTest=hitBox();
...
void BounceEni::update(MapProto* mapProto)
{
